...
public class MemberQueryService {
    ...
    public Member findBySocialProviderAndDistinctCode(String provider, String distinctCode) {
        return socialLoginQueryService.findByProviderAndDistinctCode(provider, distinctCode)
